...
mongoose.connect('mongodb+srv://pascal:HCSQMMWJj4nKMXnh@cluster0.qmu4bd5.mongodb.net/?retryWrites=true&w=majority',{useUnifiedTopology: true, useNewUrlParser: true},(err, res)=>{
    if(err){
        console.log(err);
    }else{
